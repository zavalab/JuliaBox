...
node_matrix = CSV.read("mechanical//node_matrix.csv", DataFrame)

prod_matrix = CSV.read("mechanical//product_matrix.csv", DataFrame)
demand_matrix = CSV.read("mechanical//demand_matrix.csv", DataFrame)
supply_matrix = CSV.read("mechanical//supply_matrix.csv", DataFrame)
technology_matrix = CSV.read("mechanical//technology_matrix.csv", DataFrame)


alpha_matrix = readdlm("mechanical//alpha_matrix.csv",',');
site_matrix = CSV.read("mechanical//site_matrix.csv", DataFrame)
