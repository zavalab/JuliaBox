...
const libparpipsnlp=Libdl.dlopen("/opt/PIPS/build_pips/PIPS-NLP/libparpipsnlp.so")
...
type PipsNlpProblemStruct
    ...
    function PipsNlpProblemStruct(comm, nnodes, n, m,  str_init_x0, str_prob_info, str_eval_f, str_eval_g, str_eval_grad_f, str_eval_jac_g, str_eval_h)
        prob = new(C_NULL, comm, n, m, nnodes, zeros(Float64, n),
