...
budget = '15k';
epsilon = '0.9999';
str_0 = sprintf('technologies_sited_results_%s.csv', epsilon);
...
for i = 1:length(index_4)
    scatter(lat_plot(index_4(i)), long_plot(index_4(i)),100,'b', 'filled')
end 

for i = 1:length(index_5)
    scatter(lat_plot(index_5(i)), long_plot(index_5(i)),100,'b', 'filled')
end 
...
for i = 1:length(index_7)
    scatter(lat_plot(index_7(i)), long_plot(index_7(i)),100,[0 0.5 0], 'filled')
end 

for i = 1:length(index_8)
    scatter(lat_plot(index_8(i)), long_plot(index_8(i)),100,[0 0.5 0], 'filled')
end 

for i = 1:length(index_9)
    scatter(lat_plot(index_9(i)), long_plot(index_9(i)),100,[0 0.5 0], 'filled')
end 
