...
println(num_variables(m_l))
println(num_constraints(m_l,AffExpr, MOI.EqualTo{Float64}))
println(num_constraints(m_l,AffExpr, MOI.GreaterThan{Float64}))
println(num_constraints(m_l,AffExpr, MOI.LessThan{Float64}))
