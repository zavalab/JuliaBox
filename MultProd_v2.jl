...
ideal_values		= 	readdlm("stakeholder_ideal.csv"	,',')
...
#struvite_min	=	0
epsilon		=	100
file_str	=	"0.99"		# File identifier used
file_str2	=	"alpha"		# File identifier used

# CVaR Parameters
alpha = 0.99

obj1_min	=	-283778.78039493866
obj1_max	=	4.023976984853838e-9

obj2_min	=	-343237.9570323949
obj2_max	=	6.965311466478834e-8
...
# CVaR Variables
@variable(m, dissatisfaction[SHOLDERS])
@variable(m, phi[SHOLDERS] >= 0 )
@variable(m, cvar)
@variable(m, risk)
#@variable(m, eta>=0)
...
#@constraint(m, obj == weight["sh2","o1"]*obj1_scaled + weight["sh2","o2"]*obj2_scaled)
...
@expression(m, obj1_scaled, (obj1 - obj1_min)/(obj1_max - obj1_min))
@expression(m, obj2_scaled, (obj2 - obj2_min)/(obj2_max - obj2_min))

#@constraint(m, obj1_scaled == (obj1 - obj1_min)/(obj1_max - obj1_min))
#@constraint(m, obj2_scaled == (obj2 - obj2_min)/(obj2_max - obj2_min))

#@constraint(m, obj == weight["sh5","o1"]*obj1_scaled + weight["sh5","o2"]*obj2_scaled )


@constraint(m, Dissatisfaction[sh in SHOLDERS], dissatisfaction[sh] == weight[sh, "o1"]*(obj1_scaled - ide_value[sh, "o1"] ) 
									+ weight[sh, "o2"]*(obj2_scaled - ide_value[sh, "o2"]) ) 


@constraint(m, Phi_constraint[sh in SHOLDERS], phi[sh] >= dissatisfaction[sh] - risk) 
@constraint(m, cvar_cons, cvar == (1/length(SHOLDERS))*sum{risk + (phi[sh]/(1 - alpha)), sh in SHOLDERS})
