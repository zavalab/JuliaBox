...
macro linkconstraint(m,graph,nodeoredge,args...)
    ...
    refscode = quote
        ...
        Plasmo._addlinkconstraint!($graph,$nodeoredge,cons_refs)    #add the link constraints to the node or edge and map to graph
    end
    return esc(quote
        begin
            $checkinputs
...
#TODO
#Fix issues with having a constraint reference of the form cons[...]

#generate a list of constraints, but don't attach them to the model
