...
@variable(FlareDesign,cost>=0)					#Flare stack cost
...
savefig("/home/javier/Documentos/FiguresPaperDistribution/LND_His_Rad_Cvar_95.pdf")
...
plot(Rad[xCDF],CDFRad[yCDF] ,"-", label="CVar",linewidth=1,color="black")
...
setp(ax[:get_yticklabels](),fontsize=16)
setp(ax[:get_xticklabels](),fontsize=16)
savefig("/home/javier/Documentos/FiguresPaperDistribution/LND_CDF_Cvar_95.pdf")
