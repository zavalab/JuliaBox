# Julia script
# - A economic dispatch model for fixed dispatchable load allocations
# - The dispatchable load allocations are obtained from solving a two-stage stochastic programming problem with integer variables in the first stage.
...
@addConstraint(m, DISPLOAD[n=BUSES,t=PERIODS], 
	DLoad[n,t] <= maxDispatchable * InstallDispatchable[n]);
