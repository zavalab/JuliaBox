...
struct Electrolyzer
    ...
    ρ_sb::Float64
    diffcp::Float64 #power efficiency of turbine
    diffcr::Float64 #credit multiplier
    diffeff::Float64  #max efficiency of electrolyzer
    diffem::Float64 #ci_grid multiplier
    diffspp::Float64  #spp_array multiplier
    difftier::Float64   #tier level diff scalar
    ...
    function Electrolyzer(ϕ, ξ_start, η_overpotential, V_i, ℓ, η_startup, λ_H, i, λ_CAPEX_Plant, λ_CAPEX_Stack, ρ_sb, diffcp, diffcr, diffeff, diffem, diffspp, difftier)
        ...
        λ_CAPEX_replace =  λ_CAPEX_Stack * ϕ # H. Nami et al 2022

        new(ϕ, α_max, α_min, ξ_start, η_overpotential, V_i, ℓ, δ_on, η_startup, δ_start, ρ_sb, diffcp, diffcr, diffeff, diffem, diffspp, difftier, λ_H, λ_OPEX, λ_CAPEX_Plant, λ_CAPEX_Stack, i, CRF, λ_CAPEX_yearly, λ_CAPEX_replace)
    end
end
